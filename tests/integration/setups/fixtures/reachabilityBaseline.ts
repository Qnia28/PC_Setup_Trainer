// Pre-optimization forward BFS, retained only as a bounded differential/benchmark oracle.
import { boardHash, collides, isLockable, placeCells } from "../../../../src/engine/board";
import { occupiedCells, sortedCellKey, spawnPiece } from "../../../../src/engine/pieces";
import type { ActivePiece, Board, Orientation, Piece } from "../../../../src/engine/types";
